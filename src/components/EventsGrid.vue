    ...
    <div class="events-grid">
      <div v-for="event in events" :key="event.id" class="event-card">
        ...
        <div class="event-body">
          <div class="event-cat">
            <span class="material-symbols-outlined" style="font-size: 0.9rem">label</span>{{
              event.category
            }}
          </div>
          ...
          <div class="event-footer">
            ...
            <div class="event-meta"><span class="material-symbols-outlined">group</span>{{ event.attendees }}</div>
          </div>
        </div>
      </div>
    </div>
...
const events: Event[] = [
  ...
  },
  {
    ...
    day: '18',
    month: 'JAN',
    img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAOtsljKnV__vIzi1tQZ442lzSofmbhfovLTbHd1qpASPEbXUhVqNhm3WAnf5dAUzRULtO_IE36iYsPgw5yScY6Jld3borL5HU4lYqmb0qnc-ugwSe9OqvUXMUT8YFWGaYbMhl_ip6BSSQDps1hqXG7zh2msTFQ9na7SZxkhspkdag4gC2pFQzlx84BslzXrFJ-APF9_d0Igrcb4j2jNiS4ElBhs5fKCi-0hoZ1C-NisIYYcKTW2B8MtH8wYXOpodnFNe2R0BPDBOoz',
  },
  {
    id: 5,
